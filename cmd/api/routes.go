...
func (app *application) routes() http.Handler {
	...
	router.HandlerFunc(http.MethodPost, "/v1/users/subscribe", app.createSubscription)
	router.HandlerFunc(http.MethodPut, "/v1/users/unsubscribe", app.deleteSubscription)
